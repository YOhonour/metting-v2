...
//        userById.setUserid(null);
    ...
    public ResultBean login(String key,String password,HttpServletRequest request) throws IncorrectCredentialsException, UnknownAccountException {
        Map<String,Object> map = new HashMap<>();
        map.put("jwt",userService.loginCheck(key,password));
        User user = userService.findUserByKey(key);
        map.put("user",user);
