...
//        meetingtype.setTypeid(5);
//        meetingtype.setType("科研活动");
//        meetingtypeMapper.insert(meetingtype);
        ...
        List<Meetingtype> meetingtypes = meetingtypeMapper.selectByExample(example);
        System.out.println(meetingtypes);
    }
}
